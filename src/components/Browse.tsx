...
const Browse = forwardRef(
  (
    { Albums, Playlists, Tracks, className, changeCurr, ...props }: BrowseProps,
    ...
    return (
      <AlertDialog open={open} onOpenChange={setOpen}>
        ...
        <AlertDialogContent className="flex h-3/4 w-3/4 max-w-none flex-col rounded-3xl">
          <AlertDialogHeader className="flex h-fit w-full items-start space-x-2">
